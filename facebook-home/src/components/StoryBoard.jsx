...
const NewStory = () => {
  return (
    <div className="h-40 sm:h-48 w-32 min-w-[60px] bg-white rounded-lg group shadow-sm overflow-hidden shadow-gray-300 relative flex items-end cursor-pointer">
...
const UserStory = () => {
  return (
    <div className="h-40 sm:h-48 w-32 min-w-[60px] bg-gray-200 rounded-lg shadow-sm shadow-gray-300 overflow-hidden relative">
...
const StoryPlaceholder = () => {
  return (
    <div className="h-40 sm:h-48 w-32 min-w-[60px] bg-neutral-100 rounded-xl relative">
